 ...
 */
@WebServlet("/FindAllRes")
public class FindAllRes extends HttpServlet {
	...
	PrintWriter pw = null;
	private static Logger log = Logger.getLogger(FindAllRes.class);
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		log.info("controler method is called");
		List<StudentResultHold> listStudentResultHold = addResult.findAllResults();
